...
urlpatterns = patterns('',
	   ...
	   url(r'^go_up/$', view.go_up, name='go_up'),
           url(r'^go_down/$', view.go_down, name='go_down'),
           url(r'^go_left/$', view.go_left, name='go_left'),
           url(r'^go_right/$', view.go_right, name='go_right'),
